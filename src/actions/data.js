...
export function dataVoteContestForContestantRequest() {
    return {
        type: DATA_FETCH_PROTECTED_DATA_REQUEST
    };
}
...
export function dataVoteContestForContestant(token) {
    return (dispatch, state) => {
        dispatch(dataVoteContestForContestantRequest());
        return fetch(`${SERVER_URL}/api/v1/getdata/contest/vote`, {
            credentials: 'include',
            headers: {
                Accept: 'application/json',
                Authorization: `Token ${token}`
